...
with open(strNliResultFileName, 'w', newline='') as csvfile:
    ...
    spamwriter.writerow(["strAudioPath", "text", "operation", "service", "slots", "strISS_SR_MSG_Result_0", "strISS_SR_MSG_Result_1"])
...
for row in csv_reader:
    NliResult1.append([row[0], row[1], row[2], row[3], row[4]])
del NliResult1[0]
# 读取语义结果2
NliResult2 = []
