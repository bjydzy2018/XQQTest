    ...
    if test == 'sr_effect_ch_mix':
        for test_cfg in cfg_data['tests']:
            if test_cfg['name'] == 'sr_batch':
                ...
                test_cfg['loop_num'] = '1'
                break
    if test == 'sr_time_en_local':
        for test_cfg in cfg_data['tests']:
            if test_cfg['name'] == 'sr_batch':
                test_cfg['mode'] = '1'
                test_cfg['lang'] = '1'
                test_cfg['test_mode'] = '8'
                test_cfg['loop_num'] = '1'
                break
    if test == 'sr_time_en_cloud':
        for test_cfg in cfg_data['tests']:
            if test_cfg['name'] == 'sr_batch':
                test_cfg['mode'] = '0'
                test_cfg['lang'] = '1'
    ...
    if test == 'sr_time_en_mix':
        for test_cfg in cfg_data['tests']:
            if test_cfg['name'] == 'sr_batch':
                ...
                test_cfg['loop_num'] = '1'
                break
    if test == 'sr_effect_en_local':
        for test_cfg in cfg_data['tests']:
            if test_cfg['name'] == 'sr_batch':
                test_cfg['mode'] = '1'
                test_cfg['lang'] = '1'
                test_cfg['test_mode'] = '2'
                test_cfg['loop_num'] = '1'
                break
    if test == 'sr_effect_en_cloud':
        for test_cfg in cfg_data['tests']:
            if test_cfg['name'] == 'sr_batch':
                test_cfg['mode'] = '0'
                test_cfg['lang'] = '1'
