...
private:
	...
	void testNLIBatch(Job &);
	void testUpLoadDictBatch(Job &);
	void testSeoptBatch(Job &);
    void testSeopt4Batch(Job &);
	void testSeoptSRBatch(Job & job);
	void testSRBatchVad(Job &);
	void testSRBatchAIUIEffect(Job &);
	void testSRBatchAIUITime(Job &);
