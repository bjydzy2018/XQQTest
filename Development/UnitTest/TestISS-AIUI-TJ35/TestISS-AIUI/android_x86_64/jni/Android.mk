...
LIB_FILE_PATH := $(LOCAL_PATH)/../../../../../../Project/07.Release/Android_x86_64/lib_HardEncryption/x86_64

include $(CLEAR_VARS)
LOCAL_MODULE    := vacommon_prebuilt
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../vacommon_android_x86_64/libVACommon.a
...
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../gtest_android_x86_64/libgtest.a
include $(PREBUILT_STATIC_LIBRARY)


# TestISS-AIUI
include $(CLEAR_VARS)
LOCAL_MODULE := TestISS-AIUI-android_x86_64

LOCAL_CFLAGS += -pie -fPIE
LOCAL_LDFLAGS += -pie -fPIE
LOCAL_LDLIBS += -ldl -lc -lm
