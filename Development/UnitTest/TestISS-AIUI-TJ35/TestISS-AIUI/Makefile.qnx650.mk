...
STATIC_LIBS = ./vacommon_qnx650/libVACommon.a \
./gtest_qnx650/gtest.a

SHARED_LIBS = -pthread -lm \
-L../../../../Project/07.Release/qnx650_arm/bin \
...
all: Makefile.qnx650.mk $(TARGET)
	cp $(TARGET) ../../../../Project/07.Release/qnx650_arm/bin/

clean:
	@echo -e '\e[1;34mClean... \e[0m'
	-@rm -rf $(TARGET) *.o *.gch *.d *.P ../../../../Project/07.Release/qnx650_arm/bin/$(TARGET)
