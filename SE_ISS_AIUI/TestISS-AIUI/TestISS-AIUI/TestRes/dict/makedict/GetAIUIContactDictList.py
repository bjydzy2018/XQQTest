...
org_dict_file_name = "contactDict.txt"
out_dict_file_name = "contactDict-500.txt"
out_dict_count = 500
...
dictcontant = []
Dictlist = { "dictname": "contact", "dictcontant": dictcontant }
f = open(org_dict_file_name, 'r', encoding="utf-8")
Count=0
for eachLine in f:
    line_part = eachLine.strip('\r\n')
    dictcontant_part = {"name": ""}
    dictcontant_part["name"]=line_part
